...
namespace Repository_Layer.UnitOfWork
{
         ...
         where TContext : DbContext, new()
    {
        ...
        //This CreateTransaction() method will create a database Transaction so that we can do database operations by
        ...
        public async void Save()
        {
            ...
            {
                throw new Exception("Exception thrown from database", dbEx);
            }
        }
