...
namespace Repository_Layer.Child_Repositories
{
    public class MenuRepository : Repository<Menu>, IMenuRepository
    {
        ...
        public MenuRepository(ApplicationDbContext dbContext, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IHttpContextAccessor httpContextAccessor) : base(dbContext)
        {
